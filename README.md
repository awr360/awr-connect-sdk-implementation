...
- **Default:** The page loads the SDK from the sibling package build (`../awr-connect-custom-channel-js-sdk/dist/index.umd.js`). Run `pnpm run build` in that repo first, or switch the script tag to `unpkg` `awr-client-js-sdk@0.2.0` when published.
